...
class PitchHistoryTest {
    ...
    @Test
    fun addData() {
        val pitchHistory = PitchHistory(10, TemperamentEqualTemperament(Temperament.EDO12))
        ...
        pitchHistory.appendValue(1000f, 0.0f)
        assertEquals(pitchHistory.history.value!!.size, 1)
        ...
        pitchHistory.appendValue(40f, 0.0f)
        pitchHistory.appendValue(1000f, 0.0f)
        ...
        pitchHistory.appendValue(440f, 0.0f)
        assertEquals(pitchHistory.history.value!!.size, 4)
        pitchHistory.appendValue(240f, 0.0f) // one exception is allowed when changing to a new pitch
        pitchHistory.appendValue(440f, 0.0f)
        ...
        pitchHistory.appendValue(441f, 0.0f)
        pitchHistory.appendValue(444f, 0.0f)
        pitchHistory.appendValue(450f, 0.0f)
        pitchHistory.appendValue(445f, 0.0f)
