...
data class TemperamentChainOfFifths(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TemperamentChainOfFifths
    ...
    companion object {
        fun create(vararg fifths: FifthModification, rootIndex: Int): TemperamentChainOfFifths {
            return TemperamentChainOfFifths(fifths, rootIndex)
        }
    }
}

val chainOfFifthsPythagorean = TemperamentChainOfFifths.create(
...
val chainOfFifthsQuarterCommaMeantone = TemperamentChainOfFifths.create(
...
val chainOfFifthsExtendedQuarterCommaMeantone = TemperamentChainOfFifths.create(
...
val chainOfFifthsThirdCommaMeantone = TemperamentChainOfFifths.create(
...
val chainOfFifthsFifthCommaMeantone = TemperamentChainOfFifths.create(
...
val chainOfFifthsEDO12 = TemperamentChainOfFifths.create(
...
val chainOfFifthsWerckmeisterIII = TemperamentChainOfFifths.create(
...
val chainOfFifthsWerckmeisterIV = TemperamentChainOfFifths.create(
...
val chainOfFifthsWerckmeisterV = TemperamentChainOfFifths.create(
...
val chainOfFifthsKirnberger1 = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(),
    /* GD */ FifthModification(),
...
val chainOfFifthsKirnberger2 = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(),
    /* GD */ FifthModification(),
...
val chainOfFifthsKirnberger3 = TemperamentChainOfFifths.create(
...
// für ein Dorf, 1732
val chainOfFifthsNeidhardt1 = TemperamentChainOfFifths.create(
...
val chainOfFifthsNeidhardt2 = TemperamentChainOfFifths.create(
...
val chainOfFifthsNeidhardt3 = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* GD */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* DA */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
...
val chainOfFifthsNeidhardt4 = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* GD */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* DA */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* AE */ FifthModification(pythagoreanComma = RationalNumber(-1, 12)),
...
val chainOfFifthsValotti = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* GD */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* DA */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* AE */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
...
val chainOfFifthsYoung2 = TemperamentChainOfFifths.create(
    /* CG */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* GD */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* DA */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
    /* AE */ FifthModification(pythagoreanComma = RationalNumber(-1, 6)),
